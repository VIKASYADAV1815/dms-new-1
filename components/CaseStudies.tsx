      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="mb-16">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-[10px] font-black text-green-700 uppercase tracking-[0.4em]">Tactical_Operations_History</span>
          </div>
          
          <h2 className="text-4xl md:text-6xl font-black tracking-tighter text-slate-900 leading-[0.9] mb-8 uppercase">
            OPERATIONAL <br />
            <span className="text-green-600 italic font-medium">VICTORIES.</span>
          </h2>
          ...
          <div className="max-w-md space-y-4 border-l-4 border-green-600 pl-6">
            ...
            <p className="text-[9px] text-green-700 font-black uppercase tracking-[0.3em] bg-slate-50 py-1 px-3 inline-block rounded-full border border-slate-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {caseStudies.map((study, index) => (
            <motion.div
              ...
              className="group relative bg-white border border-slate-200 rounded-2xl overflow-hidden hover:border-green-600 transition-all duration-500 shadow-premium"
            >
              ...
              <div className="p-6 relative z-10">
                <div className="flex justify-between items-center mb-6">
                  <h3 className="text-xs font-black text-slate-900 tracking-widest uppercase group-hover:text-green-700 transition-colors">
                    {study.title}
                  </h3>
                  <div className="w-8 h-8 rounded-lg bg-slate-50 border border-slate-200 flex items-center justify-center text-slate-400 group-hover:text-green-700 group-hover:border-green-600/30 transition-all shadow-sm">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-end justify-between pt-4 border-t border-slate-100">
                    <div>
                      <p className="text-[7px] font-black text-green-700/60 uppercase tracking-[0.4em] mb-1.5">VERIFIED_OUTCOME</p>
                      <p className="text-xl font-black text-slate-900 tracking-tighter tabular-nums leading-none group-hover:text-green-700 transition-colors">
                        {study.result}
                      </p>
                    </div>
                    <motion.div 
