...
export function PremiumLockHero() {
  ...
  return (
    <section className="relative min-h-[80vh] flex items-center bg-white py-24 px-6 overflow-hidden border-t border-slate-100">
            ...
            <div className="relative w-full max-w-80 aspect-square flex items-center justify-center">
              ...
              {glints.map((_, i) => (
                ...
                >
                  ...
                  <div className="relative">
                    <div className="w-1.5 h-1.5 bg-green-400 rounded-full shadow-[0_0_20px_8px_rgba(34,197,94,0.5)]" />
                    <div className="absolute -inset-2 bg-green-400/20 blur-md rounded-full" />
                  </div>
                </motion.div>
              ))}
              ...
              <div className="relative z-10 w-full h-full flex items-center justify-center scale-90 sm:scale-100">
                ...
                <div className="absolute top-0 w-32 h-44 border-[16px] border-slate-300 rounded-t-[4rem] shadow-premium">
                  ...
                  <div className="absolute inset-0 border-l-2 border-slate-100/30 rounded-t-[4rem]" />
                </div>

                {/* Main Chassis: Anisotropic Metal */}
                <div className="relative w-60 h-48 bg-linear-to-br from-slate-200 via-slate-100 to-white rounded-[3rem] shadow-premium border-2 border-slate-50 flex items-center justify-center overflow-hidden">
                  
                  {/* Subtle Shimmer across the face */}
                  <motion.div 
                    animate={{ x: [-250, 400] }}
                    transition={{ duration: 4, repeat: Infinity, ease: "linear" }}
                    className="absolute inset-y-0 w-24 bg-linear-to-r from-transparent via-green-100/20 to-transparent -skew-x-12"
                  />

                  {/* High-Precision Core */}
                  <div className="w-32 h-32 rounded-full bg-white shadow-premium border-2 border-slate-100 flex items-center justify-center relative group">
                    
                    {/* Pulsing Core Aura */}
                    <div className="absolute inset-0 bg-green-600/10 blur-3xl animate-pulse" />
                    
                    {/* Kinetic Ring */}
                    <motion.div 
                      animate={{ rotate: 360 }}
                      transition={{ duration: 10, repeat: Infinity, ease: "linear" }}
                      className="absolute inset-2 border-2 border-t-green-600 border-transparent rounded-full" 
                    />
                    
                    <motion.div 
                      animate={{ rotate: -360 }}
                      transition={{ duration: 15, repeat: Infinity, ease: "linear" }}
                      className="absolute inset-4 border border-b-green-400/50 border-transparent rounded-full" 
                    />
                    ...
                    <motion.div 
                      ...
                      className="absolute inset-x-8 h-1 bg-green-600/40 shadow-[0_0_20px_rgba(34,197,94,0.8)]"
                    />
                  </div>
                  ...
                  <div className="absolute bottom-4 flex gap-6 opacity-80">
                     ...
                     <span className="text-[8px] font-black text-green-700 uppercase tracking-[0.4em]">Sentinel_V4</span>
                  </div>
                </div>

                {/* Ground Reflection Shadow */}
                <div className="absolute -bottom-12 w-60 h-10 bg-green-600/10 blur-3xl rounded-full" />
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-12">
            <div className="space-y-8">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[10px] font-black text-green-700 uppercase tracking-[0.5em]">Secure_Protocol_v4.0</span>
              </div>
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-slate-900 leading-[0.9] tracking-tighter uppercase">
                ...
                <span className="text-transparent bg-clip-text bg-linear-to-r from-green-600 via-green-500 to-green-800 drop-shadow-sm">INFRASTRUCTURE.</span>
              </h1>
              ...
              <div className="space-y-6 max-w-xl">
                ...
                <p className="text-sm text-slate-500 leading-relaxed font-medium border-l-4 border-slate-100 pl-6">
                  We deploy proprietary <span className="text-green-700 font-black">Sentinel-V4</span> nodes that act as autonomous guardians, capable of making sub-millisecond defensive decisions without human intervention.
                </p>
              </div>
            </div>

            {/* Industrial Data Bar */}
            <div className="grid grid-cols-3 gap-8 border-t-2 border-slate-50 pt-10">
              {[
                ...
                <div key={i} className="space-y-2">
                  ...
                  <p className="text-[9px] text-green-700 uppercase font-black tracking-widest">{item.label}</p>
                </div>
              ))}
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-8 pt-6">
              ...
              <div className="flex items-center gap-3 group cursor-pointer opacity-80 hover:opacity-100 transition-all">
                ...
                <ArrowRight className="w-4 h-4 group-hover:translate-x-2 transition-transform text-green-700" />
              </div>
            </div>
          </div>
        </div>
