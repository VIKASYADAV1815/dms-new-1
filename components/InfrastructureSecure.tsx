...
export function InfrastructureSecure() {
  return (
    <section className="bg-linear-to-b from-white to-cyan-50/20 py-24 px-6 font-sans relative overflow-hidden border-t border-cyan-100">
      ...
      <div className="mx-auto max-w-7xl relative z-10">
        ...
        <div className="max-w-4xl mb-16">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-2.5 h-2.5 rounded-full bg-cyan-600 shadow-[0_0_15px_#0891b2] animate-pulse" />
            <span className="text-[10px] font-black text-cyan-700 uppercase tracking-[0.4em]">Audit_Protocol_v2.0</span>
          </div>
          <h2 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tighter leading-[0.9] mb-8 uppercase">
            IS YOUR ASSET <br />
            <span className="text-transparent bg-clip-text bg-linear-to-r from-cyan-600 to-cyan-800 italic">TRULY SECURE?</span>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <p className="text-sm text-slate-500 font-medium leading-relaxed border-l-4 border-cyan-100 pl-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24">
          {features.map((feature, idx) => (
            ...
            >
              {/* TOP SIDE BEAM */}
              <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-cyan-600/50 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-700 z-20" />

              <div className="h-full bg-white border border-cyan-100 rounded-[2rem] p-8 transition-all duration-500 group-hover:border-cyan-600/40 relative overflow-hidden shadow-premium hover:shadow-cyan">
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <h3 className="text-xl font-black text-slate-900 tracking-tight uppercase group-hover:text-cyan-700 transition-colors leading-none">
                        {feature.title}
                      </h3>
                      <span className="text-[12px] font-black text-slate-200 group-hover:text-cyan-700 transition-colors">0{idx + 1}</span>
                    </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10 border-t-2 border-cyan-50 pt-16">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-8 w-full lg:w-auto">
            <div className="text-center sm:text-right space-y-1 hidden sm:block">
              ...
              <p className="text-[10px] font-black text-cyan-700 uppercase tracking-widest flex items-center justify-end gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-cyan-600 animate-pulse shadow-[0_0_8px_#0891b2]" /> All Systems Nominal
              </p>
            </div>
