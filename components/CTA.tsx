    ...
    <section className="py-16 px-6 bg-white relative overflow-hidden border-t border-slate-200">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="absolute -left-20 -top-20 w-80 h-80 bg-green-700/5 blur-[100px] rounded-full" />
          <div className="absolute -right-20 -bottom-20 w-80 h-80 bg-green-700/5 blur-[100px] rounded-full" />
          ...
          <motion.div 
            ...
            className="absolute top-0 left-1/5 h-1 bg-linear-to-r from-transparent via-green-700/40 to-transparent" 
          />
          
          {/* --- CONTENT --- */}
          <div className="relative z-10 flex flex-col items-center text-center">
            {/* Minimal Icon with pulse */}
            <div className="relative w-12 h-12 rounded-xl bg-[#22C55E] flex items-center justify-center mb-8 shadow-premium">
              <Shield className="w-5 h-5 text-white" />
              <div className="absolute inset-0 rounded-xl bg-green-600/20 animate-pulse" />
            </div>
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.95 }}
              className="group/btn relative px-10 py-4 bg-[#22C55E] rounded-xl shadow-premium transition-all duration-500 overflow-hidden hover:bg-[#16A34A]"
            >
            ...
            <div className="mt-12 flex items-center gap-8">
              <div className="flex items-center gap-2.5">
                <div className="w-1.5 h-1.5 rounded-full bg-green-700 shadow-[0_0_12px_#22C55E]" />
